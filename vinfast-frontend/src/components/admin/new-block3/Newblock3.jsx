                ...
                <form className="formCreate" action=""> 
                    ...
                    <div className="l-8 form__create__product__right">
                        <div className="row">
                            ...
                            <div className="l-6">
                                <div className="form-group">
                                    <input value={slug } onChange={(e) => setSlug(e.target.value)} type="text" name="placement" id="placement" placeholder="Slug" />
                                </div>
                            </div>
                            <div className="l-6"> 
                                <div className="form-group">
                                    <input value={dongxe } onChange={(e) => setDongxe(e.target.value)} type="text" name="placement" id="placement" placeholder="Dong xe" />
                                </div>
                            </div>
                            <div className="l-6">
                                <div className="form-group">
